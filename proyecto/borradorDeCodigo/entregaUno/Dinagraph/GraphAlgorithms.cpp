...
int main(){
  ...
  g[0].push_back(make_pair(20, 1));
  g[0].push_back(make_pair(80, 3));
  g[0].push_back(make_pair(90, 6));
  g[1].push_back(make_pair(10, 5));
  g[5].push_back(make_pair(10, 2));
  g[5].push_back(make_pair(40, 3));
  g[2].push_back(make_pair(50, 5));
  g[2].push_back(make_pair(20, 7));
  g[2].push_back(make_pair(10, 3));
  g[3].push_back(make_pair(20, 6));
  g[6].push_back(make_pair(20, 0));
  g[4].push_back(make_pair(30, 6));
  g[4].push_back(make_pair(50, 1));
  Dijkstra(0, 7);
