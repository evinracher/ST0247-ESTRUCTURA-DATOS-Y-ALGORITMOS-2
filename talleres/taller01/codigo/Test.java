...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        /**
         * System.out.println("Recorridos:"); System.out.println(" DFS -> " +
         * convert(testDFS(gList, gMatrix))); System.out.println(" BFS -> " +
         * convert(testBFS(gList, gMatrix)));
         *
         * caminos = fillCaminos(); System.out.println("Hay Camino:");
         * System.out.println(" DFS -> " + convert(testHayCaminoDFS(gList,
         * gMatrix))); System.out.println(" BFS -> " +
         * convert(testHayCaminoBFS(gList, gMatrix)));*
         */
    }
    ...
    static boolean testSuccesors(Digraph g) {
        if (g.getSuccessors(0) != null) {
            System.out.println("Por el 0");
            return false;
        }
        if (g.getSuccessors(1) != null) {

            System.out.println("Por el 1");
            return false;
        }
